WOA AutoBot v1.5.10-beta2 打包指南
===========================
...
# 制作 DMG
hdiutil create -volname "WOA AutoBot v1.5.10-beta2" -srcfolder dist/WOA_AutoBot.app -ov -format UDZO dist/WOA_AutoBot_macOS.dmg
```
